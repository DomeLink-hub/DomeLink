-- =====================================================================
-- IMPORTANT: PROTECT ALREADY-POPULATED ENVIRONMENTS
-- If you are updating an EXISTING database (like local Docker Postgres) 
-- that already has these tables via `db push`, you MUST run this 
-- ONE-TIME command before your next migrate deploy:
--
--     npx prisma migrate resolve --applied 00000000000000_baseline
--
-- Do NOT run this resolve command against a fresh, genuinely empty database.
-- =====================================================================
...
CREATE TABLE "User" (
    ...
    "startingProjectBudget" INTEGER,
    "maximumProjectBudget" INTEGER,
    "rating" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "completedProjects" INTEGER NOT NULL DEFAULT 0,
    "reviewCount" INTEGER NOT NULL DEFAULT 0,
    "trustScore" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "onlineConsultation" BOOLEAN NOT NULL DEFAULT false,
    "offlineConsultation" BOOLEAN NOT NULL DEFAULT false,
...
-- AddForeignKey
ALTER TABLE "SavedArchitect" ADD CONSTRAINT "SavedArchitect_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "SavedArchitect" ADD CONSTRAINT "SavedArchitect_architectId_fkey" FOREIGN KEY ("architectId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
